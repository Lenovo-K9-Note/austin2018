...
ifeq ($(KEYTYPE),lenovo_releasekey)
  PRODUCT_DEFAULT_DEV_CERTIFICATE := lenovo/releasekey
  BUILD_VERSION_TAGS := release-keys
  IMAGE_SIGNATURE_KEY := lenovo/imagekey
  PRODUCT_BOOT_SIGNING_KEY := lenovo/boot_verity
endif
