...
$(SOONG_VARIABLES): FORCE
	...
	echo ''; \
	echo '    "EnabledZuiSdkFeature": $(if $(filter yes,$(ZUISDK_FEATURE_ENABLED)),true,false),'; \
	echo ''; \
	echo '    "EnabledUtouchGestureFeature": $(if $(filter yes,$(UTOUCHGESTURE_FEATURE_ENABLED)),true,false)'; \
